...
namespace MvcKutuphane.Models.Entity
{
    ...
    public partial class DBKUTUPHANEEntities : DbContext
    {
        ...
        public virtual DbSet<TBLSIFREKOD> TBLSIFREKOD { get; set; }
        ...
        public virtual ObjectResult<string> EnCokKitapVerenPersonel()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("EnCokKitapVerenPersonel");
        }
    }
}
